object day4 {
  ...
  val hash1:Option[String] = Stream.from(1) map (_.toString) find hash1      //> res0: Option[String] = Some(346386)
  ...
  Stream.from(hash1.get.toInt) map (_.toString) find hash2      //> res1: Option[String] = Some(9958218)
}